...
var Trade = /** @class */ (function () {
    ...
    Trade.prototype.ccxt = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tokens, stockToken, cashToken;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, requests_1["default"].tokens()];
                    case 1:
                        tokens = _a.sent();
                        stockToken = tokens.find(function (token) { return token.code === _this.stockTokenCode; });
                        cashToken = tokens.find(function (token) { return token.code === _this.cashTokenCode; });
                        return [2 /*return*/, {
                                id: this.id,
